    ...
    override func viewDidLoad() {
        ...
        do {
            ...
            gameStatistic.forEach { gameStat in
                ...
                selectDate = stat.date
                selectPurse = String(stat.moneyInPurse)
            }
   //         statisticArray = statisticArray.sorted{ $0.moneyInPurse > $1.moneyInPurse}
            statisticArray = statisticArray.reversed()
